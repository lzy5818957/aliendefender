...
#import "AlienDefenderAppDelegate.h"


@implementation AlienDefenderAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MyCoreDataApp" withExtension:@"momd"];
